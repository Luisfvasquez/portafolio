...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse px-lg-3" id="navbarCollapse">
            ...
            <a href="https://www.linkedin.com/in/luis-vasquez-yepez-80a857248"
                class="btn btn-outline-primary d-none d-lg-block">Contratar</a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 px-5 pl-lg-0 pb-5 pb-lg-0">
                    <img class="img-fluid w-100 rounded-circle shadow-sm" src="{{ asset('assets/img/profile.jpg') }}"
                        alt="">
                </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <p>Durante los últimos años, me he especializado en Laravel, integrando herramientas como Livewire,
                        Laravel Excel y Chart.js, así como en el diseño de arquitecturas modulares con JavaScript y
                        Alpine.js. Me apasiona mejorar la experiencia de usuario mediante interfaces dinámicas,
                        automatizar flujosy crear soluciones bien estructuradas, escalables y robustas.</p>
                    <div class="row mb-3">
                        <div class="col-sm-6 py-2">
                            <h6>Nombre: <span class="text-secondary">Luis Vasquez</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Cumpleaños: <span class="text-secondary">30 de diciembre 2002</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Grado: <span class="text-secondary">Universitario graduado</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Experiencia: <span class="text-secondary">2 años</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Teléfono: <span class="text-secondary">+58 414 5018145</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Email: <span class="text-secondary">wueyluis@gmail.com</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                            <h6>Dirección: <span class="text-secondary">Barquisimeto Venezuela</span></h6>
                        </div>
                        <div class="col-sm-6 py-2">
                    ...
                    <a href="https://www.linkedin.com/in/luis-vasquez-yepez-80a857248"
                        class="btn btn-outline-primary mr-4">Contratarme</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="border-left border-primary pt-2 pl-4 ml-2">
                        <div class="position-relative mb-4">
                            ...
                            <p class="mb-2"><strong>Instituto Universitario Jesus Obrero</strong> | <small>2022 -
                                    2025</small></p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="border-left border-primary pt-2 pl-4 ml-2">
                        ...
                        <div class="position-relative mb-4">
                            ...
                            <p>Desarrollo de un sistema web estadístico el cual incluía la gestion de gráficos, tanto
                                importacion como
                                exportacion de datos y la gestion de usuarios, todo esto con un enfoque en la usabilidad
    ...
    <div class="container-fluid py-5" id="skill">
        <div class="container">
            <div class="position-relative d-flex align-items-center justify-content-center">
                <h1 class="display-1 text-uppercase text-white" style="-webkit-text-stroke: 1px #dee2e6;">Habilidades
                </h1>
    ...
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-html5 me-2" style="color: #e44d26; font-size: 1.8rem;"></i> HTML
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-css3-alt me-2" style="color: #264de4; font-size: 1.8rem;"></i> CSS
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-js-square me-2" style="color: #f7df1e; font-size: 1.8rem;"></i> JavaScript
        </h5>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-php me-2" style="color: #8892be; font-size: 1.8rem;"></i> PHP
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-laravel me-2" style="color: #ff2d20; font-size: 1.8rem;"></i> Laravel
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fas fa-database me-2" style="color: #00758f; font-size: 1.8rem;"></i> MySQL
        </h5>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-node-js me-2" style="color: #539e43; font-size: 1.8rem;"></i> Node.js
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <i class="fab fa-git-alt me-2" style="color: #f1502f; font-size: 1.8rem;"></i> Git
        </h5>
    </div>
    <div class="col-md-4 mb-4">
        <h5 class="font-weight-bold">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/codeigniter/codeigniter-plain.svg" alt="CodeIgniter" style="height: 1.8rem;" class="me-2">
            CodeIgniter
        </h5>
    </div>
</div>
    ...
    <div class="container-fluid pt-5" id="service">
        <div class="container">
            <div class="position-relative d-flex align-items-center justify-content-center">
                <h1 class="display-1 text-uppercase text-white" style="-webkit-text-stroke: 1px #dee2e6;">Servicios
                </h1>
            ...
            <div class="row pb-3">
                ...
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    ...
                    <p>Experiencia en el desarrollo de aplicaciones web completas utilizando Laravel, CSS, JAVASCRIPT y
                        MySQL.</p>
            ...
            <div class="row portfolio-container">
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
                    <div class="position-relative overflow-hidden mb-2">
                        <img class="img-fluid rounded w-100" src="{{ asset('assets/img/portfolio-1.jpg') }}"
                            alt="">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item second">
                    <div class="position-relative overflow-hidden mb-2">
                        <img class="img-fluid rounded w-100" src="{{ asset('assets/img/portfolio-2.jpeg') }}"
                            alt="">
                        <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item third">
                    <div class="position-relative overflow-hidden mb-2">
                        <img class="img-fluid rounded w-100" src="{{ asset('assets/img/portfolio-3.jpg') }}"
                            alt="">
                        <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="contact-form text-center">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <textarea class="form-control py-3 px-4" rows="5" id="message" placeholder="Mensaje" required="required"
                                    data-validation-required-message="Por favor ingresa tu mensaje"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button class="btn btn-outline-primary" type="submit"
                                    id="sendMessageButton">Mensaje</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="container text-center py-5">
            <div class="d-flex justify-content-center mb-4">
                <a class="btn btn-light btn-social mr-2"
                    href="https://www.linkedin.com/in/luis-vasquez-yepez-80a857248"><i
                        class="fab fa-linkedin-in"></i></a>
                <a class="btn btn-light btn-social mr-2" href="https://github.com/Luisfvasquez"><i
                        class='fab fa-github'></i></a>
            </div>
            <p class="m-0">&copy; <a class="text-white font-weight-bold" href="#">Domain Name</a>. All
                Rights Reserved. Designed by <a class="text-white font-weight-bold" href="https://htmlcodex.com">HTML
                    Codex</a>
            </p>
        </div>
    </div>
